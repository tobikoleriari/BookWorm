...
<head>
    ...
    <title>Book Worm Library - Signup</title>
            ...
            <div class="row border rounded-5 p-3 bg-white shadow box-area">
                ...
                <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #008080;">
                    <div class="featured-image mb-3">
                        <img src="../LandingPage/Images/signup.jpg" class="img-fluid" style="width: 330px;" alt="Signup Image">
                    </div>
                ...
                <div class="col-md-6 right-box">
                    <div class="row align-items-center">
                        ...
                        <div class="input-group mb-3">
                            <button class="btn btn-lg btn-primary w-100 fs-6" onclick="signup()">Signup</button>
                        </div>
